...
class About extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{backgroundSize: "cover", backgroundColor: "black", color: "lightgray", backgroundImage: `url(${bg})`, lineHeight: "1.8", letterSpacing: "1px"}}>
                ...
                <div style={{ marginTop: "100px", marginBottom: "200px", display: "flex", justifyContent: "center"}}>
                    <img id="star" src={star} style={{ height: "50px", marginRight:"20px"}} />
                    <div style={{marginTop: "20px", width: "400px"}}>90's Kids is a digital collectible project and brand inspired by
                    ...
                    members to create art and skate together through contests both on and off board, both online and IRL.
                    ...
                    of NFTs in mainstream culture. This project pays homage to the striking power of skateboarding as a
                    guiding force for creativity in the Web3 era. 90s Kids provides a model example of transitioning
                        existing spaces from physical to digital.</div>
                </div>
